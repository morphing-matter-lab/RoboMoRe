...
Task Description: The walker is a two-dimensional bipedal robot consisting of seven main body parts - a single torso at the top (with the two legs splitting after the torso), two thighs in the middle below the torso, two legs below the thighs, and two feet attached to the legs on which the entire body rests. 
The goal is to walk in the forward (right) direction by applying torque to the six hinges connecting the seven body parts., you should write a reward function to make the robot move as faster as possible.
  ...
  <mujoco model="walker2d">
    ...
    <worldbody>
      ...
      <body name="torso">
        ...
        <geom fromto="0 0 {param1} 0 0 {param2}" name="torso_geom" size="{param7}" type="capsule" friction="0.9"/>
        <body name="thigh">
...
1.You should observe the parameters from the highest fitness function and further encourage this design. Also, analyze the low fitness parameters, identify their shortcomings, and avoid those design. This is very important.
