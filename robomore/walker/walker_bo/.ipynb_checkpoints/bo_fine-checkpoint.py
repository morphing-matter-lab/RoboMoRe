...
import numpy as np
import torch
from design import walker_design
...
design_params =[0.009999999776482582,0.009999999776482582,0.5,0.5,0.5,0.009999999776482582,0.009999999776482582,0.009999999776482582,0.009999999776482582,0.009999999776482582]
# init_parameter = np.array([1, 1, 1, 0.1, 0.1, 0.1])
# design_params = init_parameter + design_params

# Generate XML using Walker_design function
xml_string = walker_design(design_params)

# Save to a temporary file first
tmp_xml = f"walker_design.xml"
