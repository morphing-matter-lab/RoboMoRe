...
class GPTWalkerEnv(MujocoEnv, utils.EzPickle):
    r"""
    ## Description
    ...
    * v0: Initial versions release
    ...
    def __init__(
        ...
        healthy_z_range: Tuple[float, float] = (0.5, 3),
        # healthy_angle_range: Tuple[float, float] = (-2.5, 2.5),
#         备注：这里是之前50 10的时候的，感觉太奔放了，所以减小范围
        # healthy_z_range: Tuple[float, float] = (0.5, 2.0),
        healthy_angle_range: Tuple[float, float] = (-2, 2),
