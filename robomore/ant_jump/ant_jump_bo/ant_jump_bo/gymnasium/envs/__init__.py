...
register(
    id="GPTAntEnv",  
    entry_point="gymnasium.envs.robodesign.GPTAnt:GPTAntEnv",  
    max_episode_steps=1000,  
...
register(
    id="GPTWalkerEnv",  
    entry_point="gymnasium.envs.robodesign.GPTWalker:GPTWalkerEnv",  
    max_episode_steps=1000,  
    reward_threshold=5000.0,  
)
...
register(
    id="GPTHopperEnv",  
    entry_point="gymnasium.envs.robodesign.GPTHopper:GPTHopperEnv",  
    max_episode_steps=1000,  
    reward_threshold=5000.0,  
)
...
register(
    id="GPTSwimmerEnv",  
    entry_point="gymnasium.envs.robodesign.GPTSwimmer:GPTSwimmerEnv",  
    max_episode_steps=1000,  
    reward_threshold=5000.0,  
)
...
register(
    id="GPTCheetahEnv",  
    entry_point="gymnasium.envs.robodesign.GPTCheetah:GPTCheetahEnv",  
    max_episode_steps=1000,  
    reward_threshold=5000.0,  
)
